...
class Config:
    def __init__(self, env_file: Optional[str] = None):
        if env_file:
            ...
            load_dotenv() # 自动查找并加载项目根目录的 .env 文件
        
        self._config = self._load_config()
    
    def _load_config(self) -> Dict[str, Any]: # 读取环境变量并构建配置字典
        return {
            # OpenAI 配置
            ...
            # 数据库配置
            "default_schema_file": os.getenv("DEFAULT_SCHEMA_FILE", "data/CSpider/db_schema.json"),
